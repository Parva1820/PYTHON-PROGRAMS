...
file.write("--------------------------------------------------INVOICE--------------------------------------------------\n")
file.write("Purchase Time : " + str(purchace_time) + "\n\n")

file.write("Products Purchased:\n")

for item in p1.cart:
    file.write(products[item]["name"] + "  Rs." + str(products[item]["price"]) + "\n")

# calculate total again for file
total = 0
for item in p1.cart:
